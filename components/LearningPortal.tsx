                                    ...
                                    <div className="flex flex-col items-end gap-2 text-right">
                                      <div className="flex items-center gap-1.5 mt-1">
                                        ...
                                        <span className="text-[8px] font-black text-gray-400 uppercase tracking-widest">
                                          {inst.classroomUrl ? (inst.classroomProvider || 'Live Now') : (inst.classroomProvider ? 'Classroom Link Pending' : 'Registry Pending')}
                                        </span>
                                      </div>
                                    ...
                                    <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-8 bg-gray-50 p-6 rounded-3xl border border-gray-100">
                                      ...
                                      <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                                        {access.state === 'PAST' ? (
                                          ...
                                          <>
                                            {access.state === 'JOIN' && !inst.classroomUrl ? (
                                              <div className="px-8 py-4 bg-gray-100 text-gray-400 font-black text-[10px] uppercase tracking-widest rounded-2xl border border-gray-200 flex items-center justify-center">
